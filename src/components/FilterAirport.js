...
class FilterAirport extends React.Component {
    render() {
        return (
            <div>
                <Paper elevation={1} className="right-dir setting-forms-paper">
                    <HeaderChip label="جستجو در فرودگاه ها" icon="search" color={headerBlue}/>
                    <Divider/>
                    <br/>
...
export default connect(mapStateToProps)(FilterAirport);